...
class WorkingTestSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 5. Crear pedidos (usando distrito ID 1 que debe existir)
        DB::statement("INSERT INTO pedidos (id_venta, estado_pedido, total_pedido, fecha_pedido, fecha_entrega_estimada, id_distrito, referencia_ped, codigo_postal, id_cliente, recojo_tienda, id_encargado) VALUES 
            ...
            ({$venta2->id_venta}, 'Procesando', 1329.98, DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_ADD(NOW(), INTERVAL 2 DAY), 1, 'Casa con portón azul', '04001', {$cliente2->id_cliente}, 0, NULL),
            ({$venta3->id_venta}, 'enviado', 59.98, DATE_SUB(NOW(), INTERVAL 5 HOUR), DATE_ADD(NOW(), INTERVAL 1 DAY), 1, 'Oficina en el segundo piso', '08001', {$cliente3->id_cliente}, 0, NULL)");
